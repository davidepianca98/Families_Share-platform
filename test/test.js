...
describe('Test', () => {
  ...
  importTest('User Senior Endpoints Test', './Users/seniorEndpoints')
  importTest('Senior Endpoints Test', './Senior/seniorEndpoints')
  ...
  importTest('Material Offers Endpoints Test', './Materials/materialOfferEndpoints')
  importTest('Material Bookings Endpoints Test', './Materials/materialBookingEndpoints')
  ...
  after('Cleaning up', async () => {
    ...
    await MaterialOffer.deleteMany({})
    await MaterialRequest.deleteMany({})
    await MaterialBooking.deleteMany({})
