...
class CreateMaterialOfferStepper extends React.Component {
  ...
  createMaterialOffer = () => {
    ...
    axios
      .post(`/api/groups/${groupId}/materialOffers`, materialOffer)
      .then((response) => {
  ...
  formatDataToMaterial = (information, groupId, userId) => {
    return {
      group_id: groupId,
      creator_id: userId,
                    ...
                    <div className={classes.actionsContainer}>
                      <div>
                        <Button
                          ...
                          variant="contained"
                          color="primary"
                          onClick={this.createMaterialOffer}
                          className={
...
CreateMaterialOfferStepper.propTypes = {
