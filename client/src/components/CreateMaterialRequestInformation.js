...
class CreateMaterialRequestInformation extends React.Component {
    constructor(props) {
        super(props);
        const {
            handleSubmit,
    ...
    render() {
        ...
        const texts = Texts[language].createMaterialRequestInformation;
        const rowStyle = { minHeight: "7rem" };
        return (
            <div id="createMaterialRequestInformationContainer">
...
CreateMaterialRequestInformation.propTypes = {
...
export default withLanguage(CreateMaterialRequestInformation);
