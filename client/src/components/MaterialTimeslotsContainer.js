...
import CreateMaterialTimeslotModal from "./CreateMaterialTimeslotModal";
import ConfirmDialog from "./ConfirmDialog";

class MaterialTimeslotsContainer extends React.Component {
  constructor(props) {
    super(props);
  ...
  handleAddTimeslot = () => {
    ...
    // const { activityName: materialName, activityLocation: materialLocation } = this.props;
    this.setState({
      expandedTimeslot: {
        expanded: true,
...
export default withLanguage(MaterialTimeslotsContainer);

MaterialTimeslotsContainer.propTypes = {
