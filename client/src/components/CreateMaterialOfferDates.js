...
class CreateMaterialOfferDates extends React.Component {
  constructor(props) {
    super(props);
    const {
      handleSubmit,
...
CreateMaterialOfferDates.propTypes = {
...
export default withSnackbar(withLanguage(CreateMaterialOfferDates));
