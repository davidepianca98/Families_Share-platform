...
const MaterialOfferScreen = Loadable({
...
const MaterialBookingScreen = Loadable({
        ...
        >
          <div className="App">
            <Switch>
              ...
              />
              <PrivateRoute
                path="/groups/:groupId/materials/offers/:materialId/book"
                component={MaterialBookingScreen}
              />
              <PrivateRoute
